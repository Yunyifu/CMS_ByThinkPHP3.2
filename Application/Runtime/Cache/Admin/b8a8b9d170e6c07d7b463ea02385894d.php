...
<div id="wrapper">
    ...
    <?php
$navs = D('Menu')->getAdminMenus(); $index = 'index'; $username = session('adminUser'); $admin = $username['username']; ?>
<!-- Navigation -->
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <!--<span  attr-status="1"  attr-id="" class="sing_cursor singcms-on-off" id="singcms-on-off" attr-id="<?php echo ($vo["id"]); ?>" ><?php echo (status($vo["status"])); ?></span>-->
