<?php if (!defined('THINK_PATH')) exit(); $config = D('Basic')->show(); $navs = D('Menu')->getBarMenus(); ?>
...
<head>
  ...
  <meta name="descripition" content="<?php echo ($config["descripition"]); ?>"/>
    ...
    <div class="row">
      ...
      <div class="col-sm-3 col-md-3">
        ...
        <?php if(is_array($result['advNews'])): $i = 0; $__LIST__ = $result['advNews'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="right-hot">
          <a target="_blank" href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($vo["thumb"]); ?>" alt="<?php echo ($vo["name"]); ?>">
